    ...
    buildModal: function () {
        ...
        jQuery('.video-link').click(function () {
            jQuery.blockUI({
                ...
                css: {
                    backgroundImage: 'url("' + Engine.Environment + '/Content/images/local/' + currLocale + '/PageImages/MLP/0306/0306_modal_bg.png")',
        ...
        jwplayer('jwVideo').setup({
            ...
            'image': Engine.Environment + '/Content/images/local/' + currLocale + '/PageImages/MLP/0306/0306_modal_video_cover.jpg',
