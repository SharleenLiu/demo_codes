...
(function (cc_maker, $) {
    ...
    baseURLcategory = "http://localhost:62909/Category/en-us/" + cc_CategoryID,
    ...
    cc_processProducts = function (pdata) {
        ...
        $product.each(function (index, value) {
            ...
            jQuery(this).find('.photourl').attr('href', suburl).find('img').attr('src', (pdata[index].images.image[0].url));
    ...
    cc_getFamilyGridCategory = function () {
        ...
        if (window.location.href.toLowerCase().indexOf("localhost") != -1) {
            ...
            jQuery.when(
                        cc_getCategory({ url: 'categoryproducts.json' })
                    )
                    .done(function () {
